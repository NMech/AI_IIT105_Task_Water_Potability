...
from main_funcs                 import Classifier_Fit, return_q1_q3
#%%
...
clf_txt   = "Ridge Regression"
ridge_clf, score = Classifier_Fit(ridge_clf, X_train, y_train, Cv, clf_txt)
...
clf_txt = "Logistic Regression"
log_clf, score = Classifier_Fit(log_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
###############################################################################
############################## Linear Perceptron ##############################
###############################################################################
prc_clf = Perceptron()
clf_txt = "Linear Perceptron"
prc_clf, score = Classifier_Fit(prc_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
###############################################################################
...
clf_txt = "Linear Discriminant Analysis"
lda_clf, score = Classifier_Fit(lda_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
###############################################################################
...
clf_txt = "Quadratic Discriminant Analysis"
qda_clf, score = Classifier_Fit(qda_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
###############################################################################
...
clf_txt = "Gaussian Process Classifier"
gpc_clf, score = Classifier_Fit(gpc_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
###############################################################################
...
###############################################################################
NB_clf  = GaussianNB()
clf_txt = "Gaussian Naive Bayes"
NB_clf, score = Classifier_Fit(NB_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
###############################################################################
...
clf_txt = "Linear SVM"
svm_clf, score = Classifier_Fit(svm_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
###############################################################################
################################ Polynomial SVM ###############################
...
clf_txt     = "Polynomial SVM"
pol_svm_clf, score = Classifier_Fit(pol_svm_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
###############################################################################
...
clf_txt            = "Gaussian RBF SVM"
rbf_kernel_svm_clf, score = Classifier_Fit(rbf_kernel_svm_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
###############################################################################
...
clf_txt = "k-Neighbors"
kNeighbor_clf, score = Classifier_Fit(kNeighbor_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
###############################################################################
################################ Random Forest ################################
...
clf_txt = "Random Forest"
rnd_clf, score = Classifier_Fit(rnd_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
...
clf_txt = "Gradient Boosting"
Classifier_Fit(gdb_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
###############################################################################
################################## Ada Boost ################################## 
...
clf_txt = "Ada Boost"
Classifier_Fit(ada_clf, X_train, y_train, Cv, clf_txt)
models_CV_res.append([clf_txt, score]) 
#%%
...
###############################################################################    
if plotDiagrams == True:
    print("Plotting confusion matrix for final model")
